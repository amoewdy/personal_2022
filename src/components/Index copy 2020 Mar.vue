    ...
    <div class='recent-project'>
        ...
        <div class='right-large' style='position: relative;'>
                <!-- <div class="hint"> -->
                        ...
                        <p style='font-family:Lato, sans-serif;margin-top:0.4rem;margin-bottom:0.5rem;color:#333333;'> <b>Partner with HARMAN International</b>
                        </p>
                        </div>
                <!-- </div> -->
        </div>
    ...
    methods: {
        ...
        snow:function(){
            ...
            canvas.addEventListener("mousemove", function(e) {
                ...
                mX = e.clientX;
                mY = e.clientY;
                mX = mX - rect.left * (canvas.width/rect.width);
                mY = mY - rect.top * (canvas.height/rect.height);
            });
